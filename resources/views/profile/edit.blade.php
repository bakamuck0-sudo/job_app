<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Редактировать Проект: {{ $project->title }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('projects.update', $project) }}">
                        ...
                        <div>
                            ...
                            <input id="title" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="text" name="title" value="{{ $project->title }}" required autofocus />
                            @error('title')
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" name="description">{{ $project->description }}</textarea>
                        </div>
